...
$(document).ready(function () {
    ...
    function yourAddress() {
        ...
        $.getJSON(googleApiCall, function (locationName) {
            ...
            $(".locName").html(locationName.results[2].address_components[0].short_name);//
                    ...
                    data: [
                        {
                            ...
                            color: "blue",
                            dataPoints: [
                                { y: weatherData.hourly.data[0].temperature },
                                { y: weatherData.hourly.data[1].temperature },
                                { y: weatherData.hourly.data[2].temperature },
                                { y: weatherData.hourly.data[3].temperature },
                                { y: weatherData.hourly.data[4].temperature },
                                { y: weatherData.hourly.data[5].temperature },
                                { y: weatherData.hourly.data[6].temperature },
                                { y: weatherData.hourly.data[7].temperature },
                                { y: weatherData.hourly.data[8].temperature },
                                { y: weatherData.hourly.data[9].temperature },
                                { y: weatherData.hourly.data[10].temperature },
                                { y: weatherData.hourly.data[11].temperature },
                                { y: weatherData.hourly.data[12].temperature },
                                { y: weatherData.hourly.data[13].temperature },
                                { y: weatherData.hourly.data[14].temperature },
                                { y: weatherData.hourly.data[15].temperature },
                                { y: weatherData.hourly.data[16].temperature },
                                { y: weatherData.hourly.data[17].temperature },
                                { y: weatherData.hourly.data[18].temperature },
                                { y: weatherData.hourly.data[19].temperature },
                                { y: weatherData.hourly.data[20].temperature },
                                { y: weatherData.hourly.data[21].temperature },
                                { y: weatherData.hourly.data[22].temperature },
                                { y: weatherData.hourly.data[23].temperature },
                                { y: weatherData.hourly.data[24].temperature },
    ...
    $("#ctl00_onetidHeadbnnr2").attr("src", "../Images/arrow.gif");
    
});
$(window).load(function () {
    var curent_url = $("#ctl00_onetidProjectPropertyTitleGraphic").attr("href");
    for (var i = curent_url.length - 2; i >= 0; i--) {
        if (curent_url.charAt(i) === "/") {
            curent_url = curent_url.slice(0, i);
            break;
        }
    }
    $("#ctl00_onetidProjectPropertyTitleGraphic").attr('href', curent_url);
});